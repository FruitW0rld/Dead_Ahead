...
public class WitchRenderer extends GeoEntityRenderer<WitchEntity> {
    public WitchRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new WitchModel());
        this.shadowRadius = 0.4f;
    }

    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull WitchEntity instance) {
        return new ResourceLocation(DeadAhead.MOD_ID, "textures/entity/witch.png");
    }

    @Override
    public RenderType getRenderType(WitchEntity animatable, float partialTick, PoseStack poseStack,
